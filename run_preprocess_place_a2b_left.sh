...
# 2. 输出目录
OUT_BASE_DIR="/workspace/data/aloha_place_a2b_left"

# 3. 指令文件目录（每个episode的instruction会自动生成）
INSTRUCTION_DIR="/workspace/data/place_a2b_left/demo_randomized/instructions"
...
# --- 步骤2：数据格式转换---
echo "🔄 第2步：转换数据格式..."
cd /workspace/policy/openvla-oft
